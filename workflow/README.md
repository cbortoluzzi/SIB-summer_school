...
### Step 1:
The raw sequencing data in FASTQ format are quality checked with [`The raw sequencing data in FASTQ format are quality checked with [FastQC`][https://www.bioinformatics.babraham.ac.uk/projects/fastqc].
